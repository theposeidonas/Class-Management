...
var KTClassroomList = function () {
    var e, t, n, r, o = document.getElementById("kt_table_classroom"), c = () => {
        o.querySelectorAll('[data-kt-classroom-table-filter="delete_row"]').forEach((t => {
            t.addEventListener("click", (function (t) {
                t.preventDefault();
                const n = t.target.closest("tr"), r = n.querySelectorAll("td")[1].innerText;
                Swal.fire({
                    text: "" + r + " sınıfı silinecek, emin misiniz?",
                    icon: "warning",
                    showCancelButton: !0,
                    buttonsStyling: !1,
                    confirmButtonText: "Evet, sil!",
