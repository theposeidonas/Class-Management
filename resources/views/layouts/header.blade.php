...
<path d="M19 15V18C19 18.6 18.6 19 18 19H6C5.4 19 5 18.6 5 18V15C6.1 15 7 14.1 7 13V10C7 7.6 8.7 5.6 11 5.1V3C11 2.4 11.4 2 12 2C12.6 2 13 2.4 13 3V5.1C15.3 5.6 17 7.6 17 10V13C17 14.1 17.9 15 19 15ZM11 10C11 9.4 11.4 9 12 9C12.6 9 13 8.6 13 8C13 7.4 12.6 7 12 7C10.3 7 9 8.3 9 10C9 10.6 9.4 11 10 11C10.6 11 11 10.6 11 10Z" fill="black"/>
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                            ...
                            <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('../../../../assets/media/patterns/dropdown-header-bg.png')">
                                <!--begin::Title-->
                                <h3 class="text-white fw-bold px-9 mt-10 mb-6">Bildirimler
                                    <span class="fs-8 opacity-75 ps-3">{{ $notify->count }} Yeni</span></h3>
                                <!--end::Title-->
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade show active"  role="tabpanel">
                                    ...
                                    <div class="scroll-y mh-325px my-5 px-8">
                                        ...
                                        <div class="d-flex flex-stack py-4">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <!--begin::Title-->
                                                <div class="mb-0 me-2">
                                                    <a href="{{ route('notices') }}" class="fs-6 text-gray-800 text-hover-primary fw-bolder">{{ $not->title }}</a>
                                                    <div class="text-gray-400 fs-7">{{ substr ($not->content, 0,80) }}...</div>
                                                </div>
                                                <!--end::Title-->
                                            </div>
                                            <!--end::Section-->
                                    ...
                                    <div class="py-3 text-center border-top">
                                        <a href="{{ route('notices') }}" class="btn btn-color-gray-600 btn-active-color-primary">Hepsini Gör
