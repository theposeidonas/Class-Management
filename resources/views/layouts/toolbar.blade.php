<div class="toolbar py-5 py-lg-15" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
        ...
        <div class="d-flex align-items-center flex-wrap py-2">
            ...
            <!--end::SearchBar-->
            <!--begin::Action-->
            <a href="#" class="btn btn-custom btn-color-white btn-active-color-success my-2 me-2 me-lg-6" data-bs-toggle="modal" data-bs-target="#kt_modal_invite_friends">Öğretmen Ekle</a>
            <!--end::Action-->
            <!--begin::Button-->
            <a href="#" class="btn btn-success my-2" tooltip="New App" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app">Sınıf Ekle</a>
            <!--end::Button-->
        </div>
        <!--end::Actions-->
    </div>
